...
import poly.dn.huyndai.Repository.AuthorityRepository;
import poly.dn.huyndai.Repository.CustomerRepository;
import poly.dn.huyndai.Service.AuthorityService;
...
public class AuthorityServiceImpl implements AuthorityService {
    ...
    public List<Authority> authoritiesOf(List<Customer> customers) {
    ...
    public List<Authority> findAuthoritiesOfAdministrators(){
        List<Customer> customers = customerRepository.getAdminOrStaff();
        return authorityRepository.authoritiesOf(customers);
    }
}
